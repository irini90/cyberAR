...
def bit1():
    ...
    Zoom in to the manufacturing plant to see how the attack will play out!
    """
    print(1,nar)
...
def bit3():
    ...
    Employee downloads malicious software!  
    """
    print(3, nar)
    cur.execute("update Narration set Alert = ?", (nar,)) 
    time.sleep(6)
...
def bit5():
    ...
    """ 
    cur.execute("update Items set Skin_color = 2, State = 'Compromised' where ID = 621")
    cur.execute("update Items set Skin_color = 2, State = 'Compromised' where ID = 580")
    print(4,nar)
    cur.execute("update Narration set Alert = ?", (nar,))
    time.sleep(8)
    return
...
def bit11():
    ...
    print(4,nar)
    cur.execute("update Narration set Alert = ?", (nar,))
    cur.execute("update Items set Skin_color = 2 , State = 'Compromised', State = 'Compromised', Text_placeholder_1 = 'Malware attack' , Text_placeholder_2 = 'Version:Wannacry' , Text_placeholder_3 = 'Confidence: 95%' where ID = ?", (444,)) 
    ...
    cur.execute("update Items set Skin_color = 2 , State = 'Compromised', State = 'Compromised', Text_placeholder_1 = 'Malware attack' , Text_placeholder_2 = 'Version:Wannacry' , Text_placeholder_3 = 'Confidence: 95%' where ID = ?", (447,))  
